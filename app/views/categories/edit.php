...
<div class="col-xxl-8">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?= BASE_URL ?>categories/edit/<?= $category->id ?>">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="description" name="description"
                            rows="3" placeholder="Deskripsi kategori (opsional)"><?= htmlspecialchars($category->description ?? '') ?></textarea>
                    </div>
                </div>
